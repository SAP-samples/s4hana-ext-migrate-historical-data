...
(function (sap) {
  var getKeys = function getKeys(libOrComp, libOrCompKeysString) {
  ...
  var updateManifest = function updateManifest(manifest) {
    var result = "";
    if (manifest) {
  ...
  var updateModuleDefinition = function updateModuleDefinition(data) {
    if (data) {
...
var bundleResources = function bundleResources() {
