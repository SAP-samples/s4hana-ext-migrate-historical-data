...
public class ImportException extends RuntimeException {
     ...
     *
     * @param messageFormat the message format which will be passed as the {@code format}
     *                      parameter to {@link String#format(String, Object...)}
     * @param messageArgs   the message arguments which will be passed as the {@code args}
     *                      parameter to {@link String#format(String, Object...)}
    ...
    public ImportException(String messageFormat, Throwable cause, Object... messageArgs) {
        super(messageFormat.formatted(messageArgs), cause);
    }
    ...
    public ImportException(String messageFormat, Object... messageArgs) {
        super(messageFormat.formatted(messageArgs));
    }
